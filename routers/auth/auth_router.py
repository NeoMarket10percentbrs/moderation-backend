...
from schemas.auth import LoginResponse, TokenPairResponse, RefreshRequest, LoginRequest
...
@auth_router.post("/refresh", response_model=TokenPairResponse, summary="Обновить токены")
